...
{
    public static class CreateRecursoEntrada
    {
        public record CreateRecursoEntradaRequest(
            Guid EscenaId,
            string TipoRecurso,
            bool PrimerRecurso,
            bool UltimoRecurso,
        ...
        public sealed class Handler
        {
            ...
            public async Task<Guid> HandleAsync(CreateRecursoEntradaRequest request, Guid? actingUsuarioId, CancellationToken ct)
            {
                ...
                var recurso = new Recurso
                {
                    ...
                    Contenido = JsonSerializer.Serialize(new EntradaContenido(request.Etiqueta, request.Clave, request.Valor, request.Placeholder))
                };
                ...
                throw new ExceptionHandler(HttpStatusCode.BadRequest, new { message = "No se pudo registrar el recurso entrada" });
            }
        }
        ...
        public static class Endpoint
        {
            public static void Map(IEndpointRouteBuilder app) =>
                app.MapPost("api/recursos/entrada", async ([FromBody] CreateRecursoEntradaRequest request, Handler handler, ClaimsPrincipal user, CancellationToken ct) =>
